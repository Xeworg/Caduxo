...
- [x] Archive the change via `openspec archive caduxo-lot-movement-ledger` once the verify gate is green and delivery policy allows archive. Archive authorized by parent after formal verify report; native archive execution follows this checklist closure. <!-- sdd-owner: parent -->
